    ...
    await auth
      ...
      .then((response) => {
        ...
        if (response.additionalUserInfo.isNewUser) {
          ...
          var fcm_id = null;
          var friends_code = null;
          api.userAuth(firebase_id,"gmail",name,email,image_url,phone,fcm_id,friends_code)
            .then((response) => {
              if (response.error) {
                toast.error(response.message);
              } else {
            ...
            <div className="row morphisam">
              <div className="col-lg-6 col-md-12 col-12">
                <div className="inner__login__img justify-content-center align-items-center d-flex">
                  <img
                    src={process.env.PUBLIC_URL + "/images/login/login_img.png"}
                    alt=""
                  />
                </div>
              </div>
                ...
                <div className="inner__login__form outerline">
                  ...
                  <Form onSubmit={(e) => handleSignin(e)}>
                    ...
                    >
                      <Form.Control
                        ...
                        ref={emailRef}
                        required={true}
                        defaultValue={config.demo ? "wrteam.demo@outlook.com" : ""}
                      />
                    ...
                    >
                      <Form.Control
                        ...
                        ref={passwordRef}
                        required={true}
                        defaultValue={config.demo ? "123456" : ""}
                      />
                      <span className="emailicon2">
                        <FaLock />
                      </span>
                    </Form.Group>
                    <div className="text-end text-small mb-3 ">
                      <small><Link to={"/ResetPassword"}>{t("Forgot Password")} ?</Link></small>
                    </div>
                  ...
                  <div className="social__icons">
                    <ul>
                      ...
                      <li>
                        <button className="social__icons" onClick={() => {history.push("Otpverify");}}>
                          <FaMobileAlt />
                        </button>
                      </li>
                    </ul>
                  ...
                  <div className="sign__up">
                    <p className="">
                      {t("Dont have account")}&nbsp;
                      <span>
                        <Link to="/SignUp" replace>{t("Sign Up")}</Link>
                      </span>
                    </p>
                    <small className="text-center">{t('user agreement message')}&nbsp;
                      <u><Link className="main-color" to="/terms-conditions">{t("Terms and Conditions")}</Link></u>
                      &nbsp;&&nbsp;
                      <u><Link className="main-color" to="/privacy-policy">{t("Privacy Policy")}</Link></u>
                    </small>
                  </div>
                </div>
              </div>
