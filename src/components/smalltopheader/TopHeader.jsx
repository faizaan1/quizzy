                            ...
                            <div className="login__sign__form">
                                {isLogin() && currentUser ? (
                                    <DropdownButton id="dropdown-basic-button" title={`${t('hello')} ${currentUser.name ? currentUser.name : currentUser.email}`} className="dropdown__login">
                                        ...
                                        <Dropdown.Item onClick={handleSignout} selected>{t('Logout')}</Dropdown.Item>
                                    </DropdownButton>
                                ) : (
                                    <div>
                                        <span><Link to={"/Login"} className="login">{t('Login')}</Link></span>
                                        <span><Link to={"/SignUp"} className="signup">{t('Sign Up')}</Link></span>
                                    </div>
                                )}
                            </div>
