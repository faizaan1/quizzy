...
const Otpverify = ({ t }) => {
    ...
    const onSubmit = e => {
        ...
        if (validatePhoneNumber(phone_number)) {
            ...
            auth.signInWithPhoneNumber(phone_number, appVerifier).then(response => {
                // success
                setIsSend(true);
                setLoad(false);
    ...
    const handleVerifyCode = e => {
        e.preventDefault();
        setLoad(true);
        confirmResult.confirm(verficationCode).then(response => {
            setLoad(false);
                        ...
                        <div className="row morphisam">
                            <div className="col-md-6 col-12">
                                <div className="inner__login__img justify-content-center align-items-center d-flex">
                                    <img src={process.env.PUBLIC_URL + "/images/login/otp_img.png"} alt="" />
                                </div>
                            </div>
                                ...
                                <div className="inner__login__form outerline">
                                    ...
                                    {!isSend ? (
                                        <form className="form text-start" onSubmit={onSubmit}>
                                            <div>
                                                <label htmlFor="number" className="text-white mb-3">{t('Please Enter mobile number')} :</label>
                                                <PhoneInput
                                                    value={phoneNumber}
                                                ...
                                                <div className="send-button mt-3">
                                                    <button className="btn btn-primary" type="submit">{!load ? t('Request OTP') : t('Please Wait')}</button>
                                                    <Link className="btn btn-dark backlogin" to={"/Login"} type="button">{t('Back to Login')}</Link>
                                                </div>
                                            </div>
                                        </form>
                                    ) : null}
                                    {isSend ? (
                                        <form className="form text-start" onSubmit={handleVerifyCode}>
                                            <div className="form">
                                                <label htmlFor="code" className="text-white mb-3">{t('Enter your OTP')} :</label>
                                                <input
                                                    type="number"
                                                ...
                                                <div className="text-end">
                                                    <u>
                                                        <Link className="main-color" to="#" onClick={resendOtp} >{t("Resend OTP")}</Link>
                                                    </u>
                                                </div>
                                                <div className="btn-group">
                                                    <div className="verify-code">
                                                        <button className="btn btn-primary" type="submit">{!load ? t('Submit') : t('Please Wait')}</button>
                                                    </div>
                                                    <div className="back-button">
                                                        <button type="button" className="btn btn-dark" onClick={onChangePhoneNumber}>{t('Back')}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                    ...
                                    <div className="row">
                                        <div className="col-xl-5 col-lg-5 col-md-12 col-12 ">
                                            <div className="card main__profile pt-5 d-flex justify-content-center align-items-center">
                                                <div className="prop__image">
                                                    <img
                                                        src={profile.profile ? profile.profile : process.env.PUBLIC_URL + "/images/user.png"}
                                                        alt="profile"
                                                        id="user_profile"
                                                    />
                                        ...
                                        <div className="col-xl-7 col-lg-7 col-md-12 col-12 border-line">
                                            <div className="card p-4 bottom__card_sec">
                                                ...
                                                <Form.Group
                                                    className="mb-3 text-white d-flex"
