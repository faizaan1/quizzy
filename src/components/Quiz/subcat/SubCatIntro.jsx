        ...
        <div className="subcatintro__sec">
            <div className={`card spandiv ${active}`}>
                <div className="card__name m-auto">
                    <p className="text-center text-white m-auto d-block">{data.subcategory_name}</p>
                    <p className="text-center text-white m-auto d-block">{t('Questions')} : {data.no_of_que}</p>
                </div>
            </div>
        </div>
    )
